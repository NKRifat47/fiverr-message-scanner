...
const RiskScanner = () => {
  ...
  const scrollToRisk = (index) => {
    ...
    if (riskElements[index]) {
      ...
      // Scroll
      riskElements[index].scrollIntoView({
        behavior: "smooth",
        block: "center",
      });
    }
  ...
  const handleInput = () => {
    ...
    processed = processed.replace(riskRegex, (match) => {
      ...
      rIdx++;
      return isActive
        ? `##RISK_ACTIVE_OPEN##${match}##RISK_CLOSE##`
        : `##RISK_OPEN##${match}##RISK_CLOSE##`;
    });
    ...
    const finalHtml = processed
      .split("##RISK_ACTIVE_OPEN##")
      .join('<span class="highlight active">')
      .split("##RISK_OPEN##")
      .join('<span class="highlight">')
      .split("##RISK_CLOSE##")
      .join("</span>")
      .split("##WARN_OPEN##")
      .join('<span class="warning-highlight">')
      .split("##WARN_CLOSE##")
      .join("</span>");
    ...
    <div className="risk-scanner-container">
      <header className="header">
        ...
        <p className="subtitle">
          Edit your message. Risks are in{" "}
          <span style={{ color: "var(--danger)" }}>red</span> and warnings in{" "}
          <span style={{ color: "#b45309" }}>yellow</span>.
        </p>
      </header>
